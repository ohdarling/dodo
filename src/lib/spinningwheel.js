...
return {
	...
	destroy: function () {
		...
		var wrapper = document.getElementById('sw-wrapper');
	...
	close: function () {
		...
		if (isWebOS) {
            var self = this;
            setTimeout(function() {
                self.handleEvent({ type : 'webkitTransitionEnd', target : { id : 'sw-wrapper' } });
            }, 400);
        }
	},
	...
	scrollStart: function (e) {
		...
		var xPos = (e.targetTouches || [e])[0].clientX - this.swSlots.offsetLeft;	// Clicked position minus left offset (should be 11px)
		...
		this.startY = (e.targetTouches || [e])[0].clientY;
	...
	scrollMove: function (e) {
		var topDelta = (e.targetTouches || [e])[0].clientY - this.startY;
